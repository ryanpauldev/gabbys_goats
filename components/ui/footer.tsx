          ...
          */}
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li className="ml-4">
                <Link href="https://www.facebook.com/profile.php?id=100093448362216" className="flex justify-center items-center text-purple-600 bg-white hover:text-white hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
              ...
              <li className="ml-4">
                <Link href="https://www.facebook.com/profile.php?id=100093448362216" className="flex justify-center items-center text-purple-600 bg-white hover:text-white hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-16 h-16 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-200 text-sm mr-4">&copy; GabbysGoats.com. All rights reserved.</div>
